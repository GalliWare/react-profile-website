  ...
  return (
    <Box>
      <Tabs align="center" variant="unstyled" color="lightblue">
        <TabList>
          <Tab _selected={{ color: "black", bg: "lightblue" }}>Clocks</Tab>
          <Tab _selected={{ color: "black", bg: "lightblue" }}>Calculator</Tab>
          <Tab _selected={{ color: "black", bg: "lightblue" }}>Counter</Tab>
        </TabList>
